...
public:
  ...
  static rhoban_utils::Angle angleDiff(const ParametricLine& l1, const ParametricLine& l2);
...
std::ostream& operator<<(std::ostream& out, const rhoban_geometry::ParametricLine& p);
