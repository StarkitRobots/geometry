...
Circle Circle::circleFromTwoTangents(const Point& p1, const Point& d1, const Point& p2, const Point& d2)
{
...
Circle Circle::circleFromPoints(const Point& p1, const Point& p2, const Point& p3)
{
  ...
  c.radius = sqrt((c_x - p1.getX()) * (c_x - p1.getX()) + (c_y - p1.getY()) * (c_y - p1.getY()));
  return c;
}

Circle Circle::inscribedCircle(const Point& p1, const Point& p2, const Point& p3)
{
...
ostream& operator<<(ostream& out, const starkit_geometry::Circle& c)
{
